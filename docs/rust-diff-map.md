...
+4544 −1422 lines; 125 non-test functions touched, 37 test functions touched.

- (top level) (1083 changed lines)
...
- `snapshot_schedule` (line 2268, 68 changed lines)
- `decrypt_schedule_object_item` (line 2346, 128 changed lines)
- `create_collab_doc` (line 2406, 22 changed lines)
- `rename_collab_doc` (line 2434, 33 changed lines)
- `delete_collab_doc` (line 2472, 24 changed lines)
- `get_collab_doc_meta` (line 2495, 4 changed lines)
- `refresh` (line 2507, 3 changed lines)
- `restart_signal` (line 2519, 5 changed lines)
- `publish_visible_state` (line 2525, 77 changed lines)
- `start_reconciliation` (line 2564, 98 changed lines)
- `handle_ws_text` (line 2618, 96 changed lines)
- `snapshot_files` (line 2703, 158 changed lines)
- `snapshot_collab_docs` (line 2774, 23 changed lines)
- `snapshot_clipboard` (line 2802, 93 changed lines)
- `keep_held_revision` (line 2880, 18 changed lines)
- `holds_listed_head` (line 2900, 11 changed lines)
- `persist_file_snapshot_item` (line 2909, 27 changed lines)
- `persist_collab_snapshot_item` (line 2932, 50 changed lines)
- `persist_clipboard_snapshot_item` (line 2957, 25 changed lines)
- `current_encryption_key` (line 2982, 7 changed lines)
- `decrypt_clipboard_object_item_with_api` (line 2990, 55 changed lines)
- `handle_created_event` (line 3046, 32 changed lines)
- `handle_updated_object_event` (line 3083, 32 changed lines)
- `handle_deleted_event` (line 3116, 22 changed lines)
- `handle_updated_collab_event` (line 3146, 18 changed lines)
- `materialize_object` (line 3165, 100 changed lines)
- `materialize_collab` (line 3270, 26 changed lines)
- `remove_absent_object` (line 3297, 14 changed lines)
- `ws_loop` (line 3321, 66 changed lines)
- `ws_connect` (line 3389, 149 changed lines)
- `ws_loop` (line 3546, 65 changed lines)
- `ws_connect` (line 3613, 75 changed lines)
- `connect` (line 3710, 74 changed lines)
- `send_text` (line 3785, 5 changed lines)
- `next_text` (line 3791, 13 changed lines)
- `drop` (line 3808, 7 changed lines)
- `js_error_message` (line 3818, 5 changed lines)
- `mime_guess_from_filename` (line 3824, 21 changed lines)
- `normalized_mime_type` (line 3846, 6 changed lines)
- `safe_object_filename` (line 3853, 12 changed lines)
- `inline_ciphertext` (line 3866, 3 changed lines)
- `check_payload_ciphertext_size` (line 3876, 12 changed lines)
- `single_payload` (line 3889, 11 changed lines)
- `encrypted_clipboard_from_init` (line 3901, 9 changed lines)
- `parse_calendar_feed` (line 3913, 8 changed lines)
- `fetch_calendar_feed` (line 3939, 50 changed lines)
- `fetch_calendar_feed` (line 3991, 7 changed lines)
- `parse_instant` (line 4003, 8 changed lines)
- `encrypted_object_from_init` (line 4012, 19 changed lines)
- `encrypted_object_from_revise` (line 4032, 19 changed lines)
- `encrypted_object_from_list_item` (line 4052, 10 changed lines)
- `optional_device_id` (line 4063, 10 changed lines)
- `object_envelope_body_for_aad` (line 4080, 27 changed lines)
- `revision` (line 4122, 6 changed lines)
- `parent_hash` (line 4129, 6 changed lines)
- `operation` (line 4136, 7 changed lines)
- `object_envelope_body` (line 4146, 24 changed lines)
- `verify_object_list_item_envelope` (line 4171, 77 changed lines)
- `verify_payload_hash` (line 4251, 7 changed lines)
- `stopped_span` (line 4266, 7 changed lines)
- `check_upload_plaintext_size` (line 4278, 8 changed lines)
- `object_envelope_error` (line 4287, 3 changed lines)
- `decrypt_file_object_item` (line 4291, 21 changed lines)
- `collab_item_from_meta` (line 4314, 10 changed lines)
- `collab_created_seq` (line 4334, 8 changed lines)
- `clipboard_payload_digest` (line 4343, 7 changed lines)
- `is_supported_clipboard_mime_type` (line 4351, 3 changed lines)
- `same_mime_type` (line 4355, 3 changed lines)
- `is_not_found_error` (line 4359, 3 changed lines)
- `session_refused` (line 4366, 3 changed lines)
- `websocket_handshake_error` (line 4379, 17 changed lines)
- `spawn_background` (line 4398, 6 changed lines)
- `spawn_background` (line 4406, 6 changed lines)
- `profile_id_from_encryption_key` (line 4413, 9 changed lines)
- `hex_string` (line 4417, 14 changed lines)
- `source_record` (line 5592, 13 changed lines)
- `encrypted_schedule_object` (line 5606, 69 changed lines)
- `an_accepted_write_already_overtaken_locally_succeeds_but_a_conflicting_one_does_not` (line 5677, 61 changed lines)
- `history_cache_eviction_clears_stale_entries_without_losing_the_new_read` (line 5743, 68 changed lines)
- `logout_clears_history_cache_and_advances_the_epoch_offline` (line 5815, 31 changed lines)
...
+2672 −385 lines; 96 non-test functions touched, 30 test functions touched.

- (top level) (457 changed lines)
...
- `holds_newer_than` (line 1561, 19 changed lines)
- `validate_incoming_revision` (line 1587, 9 changed lines)
- `validate_encrypted_revision_advance` (line 1603, 44 changed lines)
- `schedule_records_with_ids` (line 1648, 14 changed lines)
- `schedule_records_with_heads` (line 1666, 10 changed lines)
- `decrypt_present_clipboard_payload` (line 1728, 2 changed lines)
- `visible_state_inner` (line 1771, 16 changed lines)
- `load_or_create_device_signing_identity_inner` (line 1801, 5 changed lines)
- `load_device_signing_identity_inner` (line 1836, 2 changed lines)
- `write_device_identity` (line 1859, 2 changed lines)
- `sweep_orphaned_temp_files` (line 1875, 23 changed lines)
- `with_database` (line 1884, 30 changed lines)
- `open_database` (line 1904, 6 changed lines)
- `discard_legacy_file_store` (line 1918, 13 changed lines)
- `stored_object_record` (line 1935, 8 changed lines)
- `write_stored_object_record` (line 1943, 5 changed lines)
- `write_stored_object_record_with_payload` (line 1956, 11 changed lines)
- `stored_object_payload_ciphertext` (line 1965, 9 changed lines)
- `live_stored_object_records` (line 1973, 30 changed lines)
- `stale_stored_object_ids` (line 1978, 18 changed lines)
- `discard_cached_payload` (line 1995, 1 changed lines)
- `remove_payloads_for_object` (line 2000, 4 changed lines)
- `remove_stored_object_record_and_payloads` (line 2005, 10 changed lines)
- `database_path` (line 2020, 4 changed lines)
- `legacy_object_dir` (line 2026, 1 changed lines)
- `legacy_clipboard_dir` (line 2030, 9 changed lines)
- `load_or_create_device_signing_identity_inner` (line 2046, 5 changed lines)
- `load_device_signing_identity_inner` (line 2086, 2 changed lines)
- `write_browser_device_identity` (line 2103, 2 changed lines)
- `write_stored_object_record` (line 2130, 2 changed lines)
- `write_stored_object_record_with_payload` (line 2166, 7 changed lines)
- `stored_object_payload_ciphertext` (line 2179, 4 changed lines)
- `live_stored_object_records` (line 2194, 3 changed lines)
- `stale_stored_object_ids` (line 2211, 43 changed lines)
- `discard_cached_payload` (line 2248, 3 changed lines)
- `remove_payloads_for_object` (line 2254, 8 changed lines)
- `remove_stored_object_record_and_payloads` (line 2265, 3 changed lines)
- `object_payload_ciphertext_key` (line 2323, 4 changed lines)
- `local_head_from_present` (line 2377, 10 changed lines)
- `revision_anchor_for_record` (line 2388, 10 changed lines)
- `present_revision_anchor` (line 2404, 11 changed lines)
- `validate_revision_against_head` (line 2416, 35 changed lines)
- `revision_anchor_error` (line 2452, 5 changed lines)
- `decrypt_file_record` (line 2481, 8 changed lines)
- `schedule_item_view_from_record` (line 2516, 12 changed lines)
- `verify_payload_ciphertext` (line 2606, 5 changed lines)
- `clipboard_display_text` (line 2625, 1 changed lines)
- `is_text_mime_type` (line 2650, 6 changed lines)
- `top_level_mime_type` (line 2654, 10 changed lines)
- `normalized_clipboard_mime_type` (line 2664, 7 changed lines)
- `device_identity_record_aad` (line 2696, 21 changed lines)
- `encrypted_device_identity_record` (line 2718, 10 changed lines)
- `device_identity_from_record` (line 2740, 19 changed lines)
...
New file, 1079 lines, 41 functions, 0 test functions.

- `new` (44), `default` (50), `fmt` (56), `contains_event` (91), `belongs_to_import` (139), `derive_id` (151), `parse_ics` (192), `parse_imported_recurrence_rules` (239), `partition_masters_and_overrides` (266), `parse_calendar` (296), `validate_calendar_envelope` (326), `value_separator` (350), `validate_rrule_numbers` (377), `is_digits` (456), `is_signed_digits` (462), `byday_ordinal_fits` (470), `unfold_content_lines` (488), `event_from_component` (505), `local` (561), `is_floating` (565), `timed_start` (569), `instant` (581), `span_from` (589), `positive_days` (649), `duration_minutes` (656), `all_day_duration` (663), `ical_duration_minutes` (677), `duration_property` (694), `recurrence_overrides` (712), `make_override` (793), `recurrence_id_for` (808), `span_at` (830), `override_count_within_limit` (847), `recurrence_values_count` (866), `recurrence_times` (879), `text_property` (904), `rrule_text` (918), `date_time_property` (942), `property` (953), `feed_time_from_entry` (963), `feed_time_from_partial` (975)
...
New file, 1023 lines, 49 functions, 0 test functions.

- `parse` (68), `uuid_fixture` (73), `import_fixture` (77), `event` (81), `readable_events_are_kept_and_unreadable_ones_are_reported` (90), `a_tzid_start_stays_pinned_to_its_zone` (106), `a_z_suffix_is_utc_rather_than_floating` (128), `a_bare_local_start_stays_floating` (143), `all_day_events_are_dates_and_dtend_is_exclusive` (152), `all_day_events_are_not_filtered_out` (175), `a_cancelled_event_is_tombstoned_not_dropped` (187), `a_representable_ingested_rule_becomes_an_editable_cadence` (198), `events_without_a_rule_happen_once` (221), `ids_are_stable_across_passes_and_distinct_per_source` (228), `an_ingested_series_expands` (259), `garbage_and_incomplete_calendars_are_rejected_but_an_empty_snapshot_is_valid` (303), `parser_has_an_input_size_ceiling` (324), `a_feed_with_too_many_lines_is_rejected_before_parsing` (331), `an_unknown_tzid_skips_the_event_instead_of_becoming_floating` (353), `old_until_values_are_validated_against_their_own_dates` (367), `windows_zone_names_resolve_for_recurrence_overrides` (381), `a_leading_utf8_bom_does_not_break_calendar_parsing` (421), `durations_use_instants_across_zones_and_dst` (431), `duration_properties_are_honoured_for_timed_and_all_day_events` (449), `exdate_rdate_and_recurrence_id_components_become_overrides` (480), `an_unsupported_range_override_skips_its_whole_series` (542), `exdate_takes_precedence_over_the_same_rdate` (558), `a_detached_instance_moved_across_the_window_boundary_still_overlaps` (575), `an_unsupported_rule_is_resolved_from_the_referenced_snapshot` (619), `runtime_rule_extraction_rejects_ambiguous_master_uids_and_rrules` (678), `feed_with_rrule` (698), `assert_malformed_rrule` (706), `rewritten_interval_and_count_rules_are_rejected` (720), `overflowing_interval_and_count_rules_are_rejected` (729), `escaped_rrule_syntax_cannot_hide_wide_intervals` (735), `narrowed_by_clauses_are_rejected` (752), `a_numeric_wkst_is_rejected` (773), `boundary_interval_and_count_are_kept` (790), `boundary_interval_expands_with_that_interval` (816), `extreme_but_exact_values_still_import` (862), `plus_signed_ordinals_are_valid_and_import_unchanged` (880), `a_folded_rrule_with_zero_interval_is_rejected` (905), `quoted_parameter_colon_does_not_hide_an_overflowing_interval` (922), `quoted_parameter_without_colon_still_validates` (936), `quoted_colon_in_non_rrule_property_does_not_hide_the_next_rrule` (945), `a_valid_interval_and_count_still_becomes_a_cadence` (967), `feed_with_exdates` (983), `too_many_exdate_values_are_rejected` (994), `ten_thousand_exdate_values_parse` (1016)
