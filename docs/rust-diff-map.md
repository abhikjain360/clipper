...
Generated from `git diff main...HEAD` on 2026-09-23. For each changed Rust file: the functions whose bodies contain added or removed lines, with the function's current line number and the number of changed lines inside it (added plus removed). New files list their functions. Test code is listed separately. Use it with [scheduler-rust-review-guide.md](scheduler-rust-review-guide.md) to read only the changed functions of the three large existing files. Regenerate it after any commit that moves code.

## crates/api-types/src/lib.rs

+342 −15 lines; 5 non-test functions touched, 8 test functions touched.

- (top level) (200 changed lines)
- `default_message` (line 842, 3 changed lines)
- `http_status` (line 908, 3 changed lines)
- `validate_revision_link` (line 1028, 19 changed lines)
- `validate_payload_count_for_operation` (line 1053, 15 changed lines)
- `validate_unique_envelope_payload_ids` (line 1069, 2 changed lines)
- tests touched: `payload`, `body`, `the_three_legal_shapes_validate`, `an_envelope_with_an_oversized_created_at_is_refused`, `a_genesis_revision_may_not_claim_a_parent`, `a_later_revision_must_carry_one`, `create_and_revision_number_must_agree`, `only_a_tombstone_may_be_empty`
...
+279 −82 lines; 43 non-test functions touched, 2 test functions touched.
...
- `with_deadline` (line 887, 10 changed lines)
- `with_transfer_deadline` (line 902, 15 changed lines)
- `sanitized_server_message` (line 1013, 15 changed lines)
- `api_error_from_parts` (line 1036, 12 changed lines)
- `api_error_from_response` (line 1059, 12 changed lines)
- `encrypt_clipboard_meta` (line 1116, 4 changed lines)
- `decrypt_clipboard_meta` (line 1129, 4 changed lines)
- `encrypt_clipboard_payload` (line 1142, 4 changed lines)
- `decrypt_clipboard_payload` (line 1154, 4 changed lines)
- `encrypt_file_meta_bytes` (line 1166, 4 changed lines)
- `decrypt_file_meta_bytes` (line 1179, 4 changed lines)
- `encrypt_file_blob_bytes` (line 1196, 4 changed lines)
- `decrypt_file_blob_bytes` (line 1208, 4 changed lines)
- `error_response` (line 1367, 5 changed lines)
- `from` (line 1407, 9 changed lines)
...
+4534 −1427 lines; 124 non-test functions touched, 37 test functions touched.

- (top level) (1086 changed lines)
- `validate_snapshot_page` (line 73, 30 changed lines)
- `try_new_with_data_dir` (line 183, 6 changed lines)
- `login_with_platform` (line 256, 1 changed lines)
- `register_with_platform` (line 318, 1 changed lines)
- `resume_with_platform` (line 395, 5 changed lines)
- `finish_auth` (line 461, 22 changed lines)
- `logout` (line 560, 5 changed lines)
- `clear_local_session` (line 580, 19 changed lines)
- `end_refused_session` (line 601, 8 changed lines)
- `end_refused_session_for` (line 619, 13 changed lines)
- `end_refused_session_for_epoch` (line 641, 13 changed lines)
- `session_is_current` (line 661, 3 changed lines)
- `start_generation_for_session` (line 673, 7 changed lines)
- `hold_session_for_write` (line 693, 10 changed lines)
- `remove_device` (line 732, 9 changed lines)
- `send_clipboard_payload` (line 763, 25 changed lines)
- `clipboard_payload` (line 968, 2 changed lines)
- `copy_to_local` (line 1002, 2 changed lines)
- `submit_single_payload_object` (line 1031, 12 changed lines)
- `finish_single_payload_object` (line 1057, 9 changed lines)
- `upload_file_bytes` (line 1136, 20 changed lines)
- `download_file_bytes` (line 1260, 33 changed lines)
- `retain_downloaded_file` (line 1319, 38 changed lines)
- `delete_file` (line 1398, 35 changed lines)
- `create_schedule_item` (line 1443, 3 changed lines)
- `create_schedule_record` (line 1454, 8 changed lines)
- `write_schedule_record` (line 1469, 9 changed lines)
- `write_schedule_record_for_session` (line 1484, 172 changed lines)
- `publish_accepted_write` (line 1626, 87 changed lines)
- `write_tombstone` (line 1661, 83 changed lines)
- `start_actual` (line 1723, 45 changed lines)
- `stop_actual` (line 1775, 5 changed lines)
- `stop_actual_inner` (line 1781, 41 changed lines)
- `actuals_between` (line 1816, 46 changed lines)
- `running_actual_ids` (line 1864, 12 changed lines)
- `update_schedule_item` (line 1881, 55 changed lines)
- `check_revision_advance` (line 1958, 6 changed lines)
- `local_head` (line 1966, 8 changed lines)
- `delete_schedule_object` (line 1981, 5 changed lines)
- `tombstone_schedule_object` (line 1987, 18 changed lines)
- `expand_schedule` (line 2012, 137 changed lines)
- `next_alarms` (line 2157, 70 changed lines)
- `add_calendar_source` (line 2229, 37 changed lines)
- `snapshot_schedule` (line 2268, 62 changed lines)
- `decrypt_schedule_object_item` (line 2340, 126 changed lines)
- `create_collab_doc` (line 2400, 22 changed lines)
- `rename_collab_doc` (line 2428, 33 changed lines)
- `delete_collab_doc` (line 2466, 24 changed lines)
- `get_collab_doc_meta` (line 2489, 4 changed lines)
- `refresh` (line 2501, 3 changed lines)
- `restart_signal` (line 2513, 5 changed lines)
- `publish_visible_state` (line 2519, 77 changed lines)
- `start_reconciliation` (line 2558, 98 changed lines)
- `handle_ws_text` (line 2612, 96 changed lines)
- `snapshot_files` (line 2697, 158 changed lines)
- `snapshot_collab_docs` (line 2768, 23 changed lines)
- `snapshot_clipboard` (line 2796, 93 changed lines)
- `keep_held_revision` (line 2874, 18 changed lines)
- `persist_file_snapshot_item` (line 2894, 31 changed lines)
- `persist_collab_snapshot_item` (line 2917, 42 changed lines)
- `persist_clipboard_snapshot_item` (line 2942, 38 changed lines)
- `current_encryption_key` (line 2967, 7 changed lines)
- `decrypt_clipboard_object_item_with_api` (line 2975, 55 changed lines)
- `handle_created_event` (line 3031, 32 changed lines)
- `handle_updated_object_event` (line 3068, 32 changed lines)
- `handle_deleted_event` (line 3101, 22 changed lines)
- `handle_updated_collab_event` (line 3131, 18 changed lines)
- `materialize_object` (line 3150, 100 changed lines)
- `materialize_collab` (line 3255, 26 changed lines)
- `remove_absent_object` (line 3282, 14 changed lines)
- `ws_loop` (line 3306, 66 changed lines)
- `ws_connect` (line 3374, 149 changed lines)
- `ws_loop` (line 3531, 65 changed lines)
- `ws_connect` (line 3598, 75 changed lines)
- `connect` (line 3695, 74 changed lines)
- `send_text` (line 3770, 5 changed lines)
- `next_text` (line 3776, 13 changed lines)
- `drop` (line 3793, 7 changed lines)
- `js_error_message` (line 3803, 5 changed lines)
- `mime_guess_from_filename` (line 3809, 21 changed lines)
- `normalized_mime_type` (line 3831, 6 changed lines)
- `safe_object_filename` (line 3838, 12 changed lines)
- `inline_ciphertext` (line 3851, 3 changed lines)
- `check_payload_ciphertext_size` (line 3861, 12 changed lines)
- `single_payload` (line 3874, 11 changed lines)
- `encrypted_clipboard_from_init` (line 3886, 9 changed lines)
- `parse_calendar_feed` (line 3898, 8 changed lines)
- `fetch_calendar_feed` (line 3924, 50 changed lines)
- `fetch_calendar_feed` (line 3976, 7 changed lines)
- `parse_instant` (line 3988, 8 changed lines)
- `encrypted_object_from_init` (line 3997, 19 changed lines)
- `encrypted_object_from_revise` (line 4017, 19 changed lines)
- `encrypted_object_from_list_item` (line 4037, 10 changed lines)
- `optional_device_id` (line 4048, 10 changed lines)
- `object_envelope_body_for_aad` (line 4065, 27 changed lines)
- `revision` (line 4107, 6 changed lines)
- `parent_hash` (line 4114, 6 changed lines)
- `operation` (line 4121, 7 changed lines)
- `object_envelope_body` (line 4131, 24 changed lines)
- `verify_object_list_item_envelope` (line 4156, 77 changed lines)
- `verify_payload_hash` (line 4236, 7 changed lines)
- `stopped_span` (line 4251, 7 changed lines)
- `check_upload_plaintext_size` (line 4263, 8 changed lines)
- `object_envelope_error` (line 4272, 3 changed lines)
- `decrypt_file_object_item` (line 4276, 21 changed lines)
- `collab_item_from_meta` (line 4299, 10 changed lines)
- `collab_created_seq` (line 4319, 8 changed lines)
- `clipboard_payload_digest` (line 4328, 7 changed lines)
- `is_supported_clipboard_mime_type` (line 4336, 3 changed lines)
- `same_mime_type` (line 4340, 3 changed lines)
- `is_not_found_error` (line 4344, 3 changed lines)
- `session_refused` (line 4351, 3 changed lines)
- `websocket_handshake_error` (line 4364, 17 changed lines)
- `spawn_background` (line 4383, 5 changed lines)
- `spawn_background` (line 4391, 9 changed lines)
- `profile_id_from_encryption_key` (line 4398, 9 changed lines)
- `hex_string` (line 4402, 14 changed lines)
- `source_record` (line 5577, 13 changed lines)
- `encrypted_schedule_object` (line 5591, 69 changed lines)
- `an_accepted_write_already_overtaken_locally_succeeds_but_a_conflicting_one_does_not` (line 5662, 61 changed lines)
- `history_cache_eviction_clears_stale_entries_without_losing_the_new_read` (line 5728, 68 changed lines)
- `logout_clears_history_cache_and_advances_the_epoch_offline` (line 5800, 31 changed lines)
- tests touched: `snapshot_pages_must_advance_and_stay_at_or_below_the_stream_start`, `calendar_fetch_errors_do_not_expose_the_private_url`, `calendar_fetch_bounds_chunked_bodies_before_reading_to_end`, `descriptor`, `envelope_payload`, `signed_item_with_payload_count`, `signed_item_with_version`, `historical_reads_require_the_exact_pinned_signed_body`, `envelope_verification_accepts_initial_format_and_rejects_unknown_versions`, `envelope_verification_rejects_over_count_payload_list_before_quadratic_work`, `envelope_verification_allows_max_payload_count_past_the_cap`, `envelope_verification_accepts_reclaimed_source_device_without_key`, `envelope_verification_rejects_bad_signature_when_key_present`, `visible_state`, `open_session`, `stopping_a_timer_clamps_a_clock_that_runs_behind`, `a_timer_start_queued_across_a_session_change_writes_nothing`, `logout_fences_sync_writes_that_are_still_in_flight`, `logout_clears_memory_after_a_writer_already_past_its_generation_check`, `refresh_does_not_block_on_the_restart_channel`, `a_restart_signal_reports_only_refreshes_asked_for_after_it_was_taken`, `a_revival_that_overtakes_its_tombstone_still_fetches_the_new_head`, `signed_file_item`, `a_download_that_outlives_its_session_is_not_retained`, `a_download_that_finishes_inside_its_session_is_retained`, `an_upload_that_outlives_its_session_is_not_persisted`, `a_refusal_from_a_replaced_session_does_not_sign_out_the_new_one`, `a_refusal_waits_for_a_session_change_already_running`, `a_socket_from_a_replaced_session_does_not_claim_the_store`, `the_websocket_loop_of_an_ended_session_stops_instead_of_reconnecting`, `a_late_view_does_not_replace_a_newer_one`, `only_a_refused_token_ends_the_session`, `a_refused_websocket_handshake_is_a_refused_session`, `a_websocket_refusal_from_a_replaced_session_does_not_sign_out_the_new_one`, `a_websocket_the_server_refuses_ends_the_session`, `a_refused_session_is_torn_down_once`, `an_oversized_upload_is_refused_before_encryption`
...
+2696 −384 lines; 96 non-test functions touched, 31 test functions touched.

- (top level) (459 changed lines)
- `new` (line 297, 8 changed lines)
- `hold_database_for_test` (line 315, 9 changed lines)
- `current_generation` (line 343, 3 changed lines)
- `mark_snapshot_seen` (line 351, 12 changed lines)
- `keep_retained_revision` (line 370, 12 changed lines)
- `refresh_seen_generation` (line 385, 14 changed lines)
- `fence_and_clear_memory` (line 410, 3 changed lines)
- `persist_local_clipboard_present_encrypted` (line 416, 2 changed lines)
- `persist_snapshot_clipboard_present_encrypted` (line 442, 28 changed lines)
- `persist_local_schedule_present_encrypted` (line 479, 20 changed lines)
- `persist_snapshot_schedule_present_encrypted` (line 504, 31 changed lines)
- `persist_schedule_present_encrypted_inner` (line 540, 40 changed lines)
- `import_file_object` (line 583, 18 changed lines)
- `import_file_ciphertext` (line 606, 16 changed lines)
- `cache_import_file_ciphertext` (line 624, 25 changed lines)
- `persist_snapshot_file_present_encrypted` (line 672, 24 changed lines)
- `hydrate_ciphertext_cache` (line 760, 10 changed lines)
- `mark_pending_fetch` (line 800, 5 changed lines)
- `apply_local_delete` (line 816, 2 changed lines)
- `apply_local_tombstone` (line 832, 20 changed lines)
- `apply_live_delete` (line 853, 2 changed lines)
- `remove_absent_object` (line 891, 2 changed lines)
- `persist_clipboard_present_encrypted_inner` (line 954, 7 changed lines)
- `persist_file_present_encrypted_inner` (line 998, 2 changed lines)
- `persist_collab_present_inner` (line 1042, 17 changed lines)
- `mark_pending_fetch_inner` (line 1105, 58 changed lines)
- `apply_delete_inner` (line 1171, 65 changed lines)
- `sweep_kind_inner` (line 1256, 40 changed lines)
- `mark_record_absent` (line 1289, 28 changed lines)
- `discard_unreadable_cache_entry` (line 1327, 10 changed lines)
- `mark_object_absent_inner` (line 1339, 19 changed lines)
- `recent_clipboard_items_inner` (line 1359, 8 changed lines)
- `file_items_inner` (line 1371, 6 changed lines)
- `collab_items_inner` (line 1375, 6 changed lines)
- `decrypt_stored_object_record_preview` (line 1391, 6 changed lines)
- `decrypt_schedule_record` (line 1421, 31 changed lines)
- `schedule_items_inner` (line 1457, 18 changed lines)
- `calendar_sources_inner` (line 1476, 21 changed lines)
- `running_actual_inner` (line 1502, 38 changed lines)
- `local_head` (line 1550, 10 changed lines)
- `holds_newer_than` (line 1561, 20 changed lines)
- `validate_incoming_revision` (line 1588, 9 changed lines)
- `validate_encrypted_revision_advance` (line 1604, 44 changed lines)
- `schedule_records_with_ids` (line 1649, 14 changed lines)
- `schedule_records_with_heads` (line 1667, 10 changed lines)
- `decrypt_present_clipboard_payload` (line 1729, 2 changed lines)
- `visible_state_inner` (line 1772, 16 changed lines)
- `load_or_create_device_signing_identity_inner` (line 1802, 5 changed lines)
- `load_device_signing_identity_inner` (line 1837, 2 changed lines)
- `write_device_identity` (line 1860, 2 changed lines)
- `sweep_orphaned_temp_files` (line 1876, 23 changed lines)
- `with_database` (line 1885, 30 changed lines)
- `open_database` (line 1905, 6 changed lines)
- `discard_legacy_file_store` (line 1919, 13 changed lines)
- `stored_object_record` (line 1936, 8 changed lines)
- `write_stored_object_record` (line 1944, 5 changed lines)
- `write_stored_object_record_with_payload` (line 1957, 11 changed lines)
- `stored_object_payload_ciphertext` (line 1966, 9 changed lines)
- `live_stored_object_records` (line 1974, 30 changed lines)
- `stale_stored_object_ids` (line 1979, 18 changed lines)
- `discard_cached_payload` (line 1996, 1 changed lines)
- `remove_payloads_for_object` (line 2001, 4 changed lines)
- `remove_stored_object_record_and_payloads` (line 2006, 10 changed lines)
- `database_path` (line 2021, 4 changed lines)
- `legacy_object_dir` (line 2027, 1 changed lines)
- `legacy_clipboard_dir` (line 2031, 9 changed lines)
- `load_or_create_device_signing_identity_inner` (line 2047, 5 changed lines)
- `load_device_signing_identity_inner` (line 2087, 2 changed lines)
- `write_browser_device_identity` (line 2104, 2 changed lines)
- `write_stored_object_record` (line 2131, 2 changed lines)
- `write_stored_object_record_with_payload` (line 2167, 7 changed lines)
- `stored_object_payload_ciphertext` (line 2180, 4 changed lines)
- `live_stored_object_records` (line 2195, 3 changed lines)
- `stale_stored_object_ids` (line 2212, 43 changed lines)
- `discard_cached_payload` (line 2249, 3 changed lines)
- `remove_payloads_for_object` (line 2255, 8 changed lines)
- `remove_stored_object_record_and_payloads` (line 2266, 3 changed lines)
- `object_payload_ciphertext_key` (line 2324, 4 changed lines)
- `local_head_from_present` (line 2378, 10 changed lines)
- `revision_anchor_for_record` (line 2389, 10 changed lines)
- `present_revision_anchor` (line 2405, 11 changed lines)
- `validate_revision_against_head` (line 2417, 35 changed lines)
- `revision_anchor_error` (line 2453, 5 changed lines)
- `decrypt_file_record` (line 2482, 8 changed lines)
- `schedule_item_view_from_record` (line 2517, 12 changed lines)
- `verify_payload_ciphertext` (line 2607, 5 changed lines)
- `clipboard_display_text` (line 2626, 1 changed lines)
- `is_text_mime_type` (line 2651, 5 changed lines)
- `top_level_mime_type` (line 2655, 7 changed lines)
- `normalized_clipboard_mime_type` (line 2665, 9 changed lines)
- `device_identity_record_aad` (line 2697, 21 changed lines)
- `encrypted_device_identity_record` (line 2719, 10 changed lines)
- `device_identity_from_record` (line 2741, 19 changed lines)
- tests touched: `encrypted_clipboard`, `encrypted_clipboard_at`, `file_item`, `encrypted_file_at`, `collab_item`, `encrypts_device_identity_at_rest`, `tampered_device_identity_record`, `rejects_device_identity_record_with_a_substituted_device_id`, `rejects_device_identity_record_with_a_malformed_device_id`, `rejects_device_identity_record_copied_from_another_profile`, `hydrate_sweeps_orphaned_temp_files`, `opening_the_store_discards_the_file_based_one_it_replaces`, `restricts_cache_permissions_and_does_not_store_plaintext`, `a_newer_event_for_a_pending_object_asks_for_another_fetch`, `a_create_for_a_held_object_fetches_only_when_it_is_newer`, `delete_marker_keeps_revision_anchor_across_sweeps_and_restart`, `snapshot_absence_retains_head_without_forcing_a_new_revision`, `locally_signed_tombstone_is_a_durable_exact_head`, `hydration_keeps_the_anchor_when_cached_content_cannot_be_read`, `a_tombstone_at_the_same_revision_is_a_conflict_not_a_newer_revision`, `wiping_the_cache_leaves_every_anchor_standing`, `a_deleted_object_leaves_nothing_for_hydration_to_read`, `dropping_an_object_reclaims_its_cached_payload`, `a_stale_snapshot_page_skips_one_item_and_keeps_going`, `an_equivocating_snapshot_body_is_skipped`, `a_held_collab_doc_does_not_break_the_view`, `a_collab_listing_cannot_erase_an_encrypted_objects_anchor`, `a_chainless_record_cannot_take_an_anchor_away`, `a_late_local_tombstone_cannot_lower_the_anchor`, `validating_an_incoming_revision_honours_an_absent_anchor`, `validating_an_incoming_revision_honours_an_observed_delete_anchor`

## crates/client/src/local_store/adversarial_tests.rs

New file, 1162 lines, 25 functions, 0 test functions.

- `item` (19), `encrypted_clipboard_at` (30), `head_of` (100), `successor` (108), `new_store` (123), `revision_error_text` (129), `served_revision_older_than_accepted_anchor_is_rejected` (136), `different_body_at_the_accepted_revision_is_rejected` (162), `successor_with_wrong_parent_hash_is_rejected` (196), `skipped_link_is_accepted_as_documented` (228), `event_stream_delete_requires_two_newer_revisions` (266), `not_found_absence_keeps_the_anchor_and_allows_the_same_head` (314), `signed_tombstone_chains_the_restore_and_rejects_wrong_parent` (354), `undecryptable_payload_bytes_keep_the_anchor` (412), `cache_row_eviction_keeps_the_anchor` (465), `uncommitted_transaction_leaves_no_trace_and_prior_data_survives` (523), `payload_write_rejected_for_a_marker_leaves_no_partial_record` (586), `concurrent_writers_to_one_object_never_leave_torn_state` (650), `repeated_snapshot_page_is_idempotent` (767), `the_first_pass_after_a_restart_sweeps_an_object_the_previous_run_last_saw` (841), `snapshot_item_at_lower_revision_than_local_is_rejected` (882), `one_malformed_content_row_must_not_drop_the_other_objects` (929), `live_row_with_null_content_must_not_brick_refetch_or_sweep` (990), `an_unknown_stored_kind_degrades_the_object_instead_of_failing_its_reads` (1077), `corrupt_anchor_row_must_not_brick_every_later_event_for_that_object` (1116)

## crates/client/src/local_store/sqlite.rs

New file, 756 lines, 21 functions, 0 test functions.

- `open` (79), `create_private_file_if_missing` (120), `read_record` (142), `unreadable_cache_row` (217), `live_records` (236), `stale_object_ids` (340), `write_record` (365), `read_payload` (456), `delete_payload` (473), `forget_object` (491), `anchor_has_chain_position` (512), `upsert_object` (527), `upsert_anchor` (565), `write_departed_anchor` (601), `carry_anchor` (623), `read_anchor_row` (639), `damaged_anchor_dropped` (693), `revision_anchor` (709), `object_kind` (731), `anchor_kind_text` (738), `anchor_kind_from_text` (746)
...
New file, 1377 lines, 6 functions, 0 test functions.

- `drop` (20), `wait_for` (26), `server_command` (39), `live_schedule_revisions_timers_feeds_and_two_devices` (54), `imported_source_readiness_requires_a_complete_active_batch` (1043), `exercise_revision_aware_plans` (1137)
...
+29 −29 lines; 2 non-test functions touched, 5 test functions touched.

- (top level) (12 changed lines)
- `register` (line 27, 3 changed lines)
- `broadcast` (line 43, 2 changed lines)
- tests touched: `next_line`, `broadcast_reaches_all_clients`, `unregister_stops_delivery`, `broadcast_removes_dead_clients`, `a_slow_client_stays_connected_and_receives_the_newest_state`

## crates/daemon/src/handler.rs

+152 −7 lines; 11 non-test functions touched, 0 test functions touched.

- (top level) (25 changed lines)
- `handle_connection` (line 46, 13 changed lines)
- `dispatch_command` (line 390, 25 changed lines)
- `cmd_create_schedule_item` (line 748, 10 changed lines)
- `cmd_update_schedule_item` (line 759, 13 changed lines)
- `cmd_delete_schedule_object` (line 773, 10 changed lines)
- `cmd_expand_schedule` (line 784, 13 changed lines)
- `cmd_start_actual` (line 798, 10 changed lines)
- `cmd_stop_actual` (line 809, 10 changed lines)
- `cmd_actuals_between` (line 820, 10 changed lines)
- `cmd_add_calendar_source` (line 831, 10 changed lines)
- `cmd_sync_calendar_source` (line 842, 10 changed lines)

## crates/daemon/src/main.rs

+33 −7 lines; 2 non-test functions touched, 0 test functions touched.

- (top level) (4 changed lines)
...
New file, 593 lines, 20 functions, 0 test functions.

- `overlapping_occurrences` (59), `next_after` (85), `maximum_lookback` (106), `span_lookback` (120), `default` (150), `new` (159), `with_max_candidates` (163), `with_imported_rules` (172), `rule_spans` (181), `insert` (342), `merge` (354), `lookup` (358), `is_empty` (362), `occurrences` (368), `effective_zone` (444), `recurrence_id` (462), `span_at` (484), `rrule_line` (515), `rule_until_before_start` (557), `ical_weekday` (568)

## crates/schedule/src/ingest.rs

New file, 1093 lines, 42 functions, 0 test functions.

- `new` (44), `default` (50), `fmt` (56), `contains_event` (91), `belongs_to_import` (139), `derive_id` (151), `parse_ics` (192), `parse_imported_recurrence_rules` (239), `partition_masters_and_overrides` (266), `parse_calendar` (296), `validate_calendar_envelope` (326), `value_separator` (350), `validate_rrule_numbers` (372), `name_characters` (455), `is_digits` (463), `is_signed_digits` (469), `byday_ordinal_fits` (477), `unfold_content_lines` (495), `event_from_component` (512), `local` (568), `is_floating` (572), `timed_start` (576), `instant` (588), `span_from` (596), `positive_days` (656), `duration_minutes` (663), `all_day_duration` (670), `ical_duration_minutes` (684), `duration_property` (701), `recurrence_overrides` (719), `make_override` (800), `recurrence_id_for` (815), `span_at` (837), `override_count_within_limit` (854), `recurrence_values_count` (873), `recurrence_times` (886), `text_property` (911), `rrule_text` (925), `date_time_property` (949), `property` (960), `feed_time_from_entry` (970), `feed_time_from_partial` (982)
...
New file, 581 lines, 24 functions, 0 test functions.

- `from_imported_rule` (40), `new` (59), `as_str` (103), `until_wall_clock` (125), `until_value_wall_clock` (144), `until_scan_bound` (171), `every` (187), `each` (199), `ending` (207), `try_from` (223), `from_start` (298), `from_end` (302), `check` (306), `as_ical` (315), `last` (368), `serialize` (397), `deserialize` (408), `serde_weekday_name` (474), `serde_weekday_from_name` (486), `just` (511), `weekdays` (516), `contains` (527), `iter` (531), `after` (557)
...
New file, 330 lines, 9 functions, 6 test functions.

- `summary` (20), `phrase` (67), `recurrence_summary` (98), `time_summary` (110), `weekly_phrase` (133), `weekday_list` (140), `weekday_name` (149), `month_name` (161), `ordinal` (179)
...
New file, 1037 lines, 50 functions, 0 test functions.

- `parse` (68), `uuid_fixture` (73), `import_fixture` (77), `event` (81), `readable_events_are_kept_and_unreadable_ones_are_reported` (90), `a_tzid_start_stays_pinned_to_its_zone` (106), `a_z_suffix_is_utc_rather_than_floating` (128), `a_bare_local_start_stays_floating` (143), `all_day_events_are_dates_and_dtend_is_exclusive` (152), `all_day_events_are_not_filtered_out` (175), `a_cancelled_event_is_tombstoned_not_dropped` (187), `a_representable_ingested_rule_becomes_an_editable_cadence` (198), `events_without_a_rule_happen_once` (221), `ids_are_stable_across_passes_and_distinct_per_source` (228), `an_ingested_series_expands` (259), `garbage_and_incomplete_calendars_are_rejected_but_an_empty_snapshot_is_valid` (303), `parser_has_an_input_size_ceiling` (324), `a_feed_with_too_many_lines_is_rejected_before_parsing` (331), `an_unknown_tzid_skips_the_event_instead_of_becoming_floating` (353), `old_until_values_are_validated_against_their_own_dates` (367), `windows_zone_names_resolve_for_recurrence_overrides` (381), `a_zone_known_only_by_its_utc_offset_is_refused` (421), `a_leading_utf8_bom_does_not_break_calendar_parsing` (432), `durations_use_instants_across_zones_and_dst` (442), `duration_properties_are_honoured_for_timed_and_all_day_events` (460), `exdate_rdate_and_recurrence_id_components_become_overrides` (491), `an_unsupported_range_override_skips_its_whole_series` (553), `exdate_takes_precedence_over_the_same_rdate` (569), `a_detached_instance_moved_across_the_window_boundary_still_overlaps` (586), `an_unsupported_rule_is_resolved_from_the_referenced_snapshot` (630), `runtime_rule_extraction_rejects_ambiguous_master_uids_and_rrules` (689), `feed_with_rrule` (709), `assert_malformed_rrule` (717), `rewritten_interval_and_count_rules_are_rejected` (731), `overflowing_interval_and_count_rules_are_rejected` (740), `escaped_rrule_syntax_cannot_hide_wide_intervals` (746), `narrowed_by_clauses_are_rejected` (766), `a_numeric_wkst_is_rejected` (787), `boundary_interval_and_count_are_kept` (804), `boundary_interval_expands_with_that_interval` (830), `extreme_but_exact_values_still_import` (876), `plus_signed_ordinals_are_valid_and_import_unchanged` (894), `a_folded_rrule_with_zero_interval_is_rejected` (919), `quoted_parameter_colon_does_not_hide_an_overflowing_interval` (936), `quoted_parameter_without_colon_still_validates` (950), `quoted_colon_in_non_rrule_property_does_not_hide_the_next_rrule` (959), `a_valid_interval_and_count_still_becomes_a_cadence` (981), `feed_with_exdates` (997), `too_many_exdate_values_are_rejected` (1008), `ten_thousand_exdate_values_parse` (1030)

## crates/schedule/tests/until.rs

New file, 254 lines, 18 functions, 0 test functions.

- `local` (15), `utc` (19), `berlin_span` (25), `cadence_item` (35), `imported_item` (46), `expand` (65), `expand_imported` (76), `fall_back_expansion` (88), `spring_forward_expansion` (96), `instant_until_includes_fold_day_before_the_cutoff` (107), `imported_instant_until_includes_fold_day_before_the_cutoff` (121), `instant_until_excludes_gap_day_after_the_cutoff` (133), `imported_instant_until_excludes_gap_day_after_the_cutoff` (144), `date_until_includes_the_whole_last_day` (153), `until_before_start_is_empty_but_added_override_remains` (163), `local_midnight_window` (189), `until_slack_skips_an_unresolvable_day_past_the_cutoff` (205), `resolved_fold_candidate_keeps_instant_cutoff_despite_later_wall_clock` (242)
...
## crates/server/src/collab_sync.rs

+1 −1 lines; 0 non-test functions touched, 0 test functions touched.

- (top level) (2 changed lines)

## crates/server/src/config.rs

+17 −10 lines; 1 non-test functions touched, 2 test functions touched.

- (top level) (15 changed lines)
- `apply_overrides` (line 317, 4 changed lines)
...
+8 −28 lines; 1 non-test functions touched, 0 test functions touched.

- (top level) (34 changed lines)
- `to` (line 55, 2 changed lines)
...
## crates/server/src/migration/m20260615_000002_collab_docs.rs
...
New file, 277 lines, 2 functions, 0 test functions.
...
+15 −6 lines; 0 non-test functions touched, 3 test functions touched.

- (top level) (1 changed lines)
- tests touched: `challenge_request`, `registration_start_request`, `challenge_rate_limits_by_username_across_client_ips`

## crates/server/src/routes/collab.rs

+8 −10 lines; 1 non-test functions touched, 0 test functions touched.
...
+4124 −1175 lines; 39 non-test functions touched, 61 test functions touched.
